...
@Component({
  selector: 'app-summary-for-current-day-report',
  templateUrl: './summary-for-current-day-report.component.html',
  styleUrls: ['./summary-for-current-day-report.component.css',
              '../report-cost.component.css']
})
export class SummaryForCurrentDayReportComponent extends ReportCostComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.reportCostService.generateSummaryForCurrentDayReport(this.groupCategoryTotalReportFilter).subscribe(data => {
