...
@Component({
  selector: 'app-detail-by-resource-report',
  templateUrl: './detail-by-resource-report.component.html',
  styleUrls: ['./detail-by-resource-report.component.css',
  '../report-cost.component.css']
})
export class DetailByResourceReportComponent extends ReportCostComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.reportCostService.generateDetailByResourceReport(this.groupCategoryTotalReportFilter).subscribe(data => {
