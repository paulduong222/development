...
@Component({
  selector: 'app-summary-by-resource-report',
  templateUrl: './summary-by-resource-report.component.html',
  styleUrls: ['./summary-by-resource-report.component.css',
              '../report-cost.component.css']
})
export class SummaryByResourceReportComponent extends ReportCostComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.reportCostService.generateSummaryByResourceReport(this.groupCategoryTotalReportFilter).subscribe(data => {
