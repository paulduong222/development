...
@Component({
  selector: 'app-group-category-total-report',
  templateUrl: './group-category-total-report.component.html',
  styleUrls: ['./group-category-total-report.component.css',
              '../report-cost.component.css']
})
export class GroupCategoryTotalReportComponent extends ReportCostComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.reportCostService.generateGroupCategoryTotalReport(this.groupCategoryTotalReportFilter).subscribe(data => {
