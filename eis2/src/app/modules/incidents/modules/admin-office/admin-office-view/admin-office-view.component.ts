...
@Component({
  selector: 'app-admin-office-view',
  templateUrl: './admin-office-view.component.html',
  styleUrls: ['./admin-office-view.component.css']
})
export class AdminOfficeViewComponent implements OnInit {
  ...
  @ViewChild('adminOfficeForm') adminOfficeForm: AdminOfficeFormComponent;
  gridColumnDefs = [
    {headerName: 'Office Name', field: 'officeName', width: 250},
    {headerName: 'Address 1', field: 'addressLine1', width: 135},
    {headerName: 'Address 2', field: 'addressLine2', width: 135},
  ...
  calcHt(){
    return HeightCalc.calculateHeight('adminoffice');
  }
