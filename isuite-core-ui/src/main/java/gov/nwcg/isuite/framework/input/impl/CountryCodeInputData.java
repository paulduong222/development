...
/**
 * Country Code data to be input into the system.
 * @author doug
 *
 */
public class CountryCodeInputData extends InputDataImpl {
   
   private static final long serialVersionUID = 6279289248330584329L;
   private String name;
    ...
    */
   public CountryCodeInputData(String uniqueIdentifier, InputDataSource source, String name, String abbreviation) {
   ...
   public boolean equals(Object obj) {
      ...
      if ( getClass() != obj.getClass() )
         return false;
      final CountryCodeInputData other = (CountryCodeInputData) obj;
