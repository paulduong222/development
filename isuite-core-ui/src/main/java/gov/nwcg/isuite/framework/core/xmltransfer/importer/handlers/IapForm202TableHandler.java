...
public class IapForm202TableHandler extends BaseTableHandler implements TableHandler {
	...
	private void updateClobData() throws Exception {
		...
		String objectives=(String)XmlTransferUtil.invokeGetMethod(xmlObject, "Objectives");
		String commandEmphasis=(String)XmlTransferUtil.invokeGetMethod(xmlObject, "CommandEmphasis");
		String gsa=(String)XmlTransferUtil.invokeGetMethod(xmlObject, "GeneralSituationalAwareness");
