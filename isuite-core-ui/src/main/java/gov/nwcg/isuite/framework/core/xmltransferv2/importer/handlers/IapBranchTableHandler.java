...
public class IapBranchTableHandler extends BaseTableHandler implements TableHandler {
	...
	private void updateClobData() throws Exception {
		...
		XmlField xfSI = xmlTable.getXmlFieldBySqlName("SPECIAL_INSTRUCTIONS");
		XmlField xfWA = xmlTable.getXmlFieldBySqlName("WORK_ASSIGNMENT");
		
		String specialInstructions=(String)XmlTransferUtil.invokeGetMethod(xmlObject, xfSI.name);
		String workAssignment=(String)XmlTransferUtil.invokeGetMethod(xmlObject, xfWA.name);
