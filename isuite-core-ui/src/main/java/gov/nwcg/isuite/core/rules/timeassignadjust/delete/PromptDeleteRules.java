...
public class PromptDeleteRules extends AbstractTimeAssignAdjustDeleteRule implements IRule{
	public static final String _RULE_NAME=TimeAssignAdjustDeleteRuleFactory.RuleEnum.PROMPT_DELETE.name();
