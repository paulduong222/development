...
public class IapForm204Report4Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_4Comm";
	...
	public IapForm204Report4Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report4Comm.REPORT_NAME;
	}
