...
@XmlTransferTable(name = "IswlCat1B", table = "iswl_cat_1_b")
public class IswlCat1B {

	@XmlTransferField(name = "Id", sqlname="ID", primarykey=true, sequence="SEQ_CAT1B", type="LONG")
	private Long id = 0L;
