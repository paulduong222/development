...
public class CheckPermissionsRules extends AbstractIncidentGroupDeleteRule implements IRule{
	public static final String _RULE_NAME=IncidentGroupDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
