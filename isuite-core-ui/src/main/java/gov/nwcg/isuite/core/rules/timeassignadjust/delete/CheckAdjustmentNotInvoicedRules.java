...
public class CheckAdjustmentNotInvoicedRules extends AbstractTimeAssignAdjustDeleteRule implements IRule{
	public static final String _RULE_NAME=TimeAssignAdjustDeleteRuleFactory.RuleEnum.CHECK_ADJUSTMENT_NOT_INVOICED.name();
