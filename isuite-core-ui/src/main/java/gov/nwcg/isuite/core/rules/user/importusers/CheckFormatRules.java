...
public class CheckFormatRules extends AbstractImportUsersRule implements IRule{
	public static final String _RULE_NAME=ImportUserAccountsRuleFactory.RuleEnum.CHECK_PASSWORD_FORMAT_RULE.name();
	...
	private int runRuleCheck(DialogueVo dialogueVo) {
		...
		//TODO:  Call PasswordUtility to accomplish the validation below
	    ...
	    matcher = pattern.matcher(defaultPassword);
	    if(!matcher.find()) {
