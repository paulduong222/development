...
public class CheckPermissionsRules extends AbstractSettingSaveRule implements IRule {
	public static final String _RULE_NAME=SettingSaveRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
