...
public class CheckPermissionsRules extends AbstractTimeAssignAdjustDeleteBatchRule implements IRule{
	public static final String _RULE_NAME=TimeAssignAdjustDeleteBatchRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
