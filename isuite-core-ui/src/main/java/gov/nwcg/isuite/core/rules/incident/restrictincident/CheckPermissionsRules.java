...
public class CheckPermissionsRules extends AbstractRestrictIncidentRule implements IRule{
	public static final String _RULE_NAME=RestrictIncidentRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
