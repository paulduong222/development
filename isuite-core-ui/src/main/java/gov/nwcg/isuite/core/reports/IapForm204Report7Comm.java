...
public class IapForm204Report7Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_7Comm";
	...
	public IapForm204Report7Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report7Comm.REPORT_NAME;
	}
