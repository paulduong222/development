...
public class CheckPermissionsRules extends AbstractMasterFrequencyDeleteRule implements IRule {
	public static final String _RULE_NAME=MasterFrequencyDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
