...
public class CheckPermissionsRules extends AbstractDeleteUserIGRule implements IRule{
	public static final String _RULE_NAME=IncidentGroupDeleteUserRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
