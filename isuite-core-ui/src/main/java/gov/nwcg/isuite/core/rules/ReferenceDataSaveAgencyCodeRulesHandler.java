...
public class ReferenceDataSaveAgencyCodeRulesHandler extends AbstractRuleHandler {
	
	public ReferenceDataSaveAgencyCodeRulesHandler(ApplicationContext ctx) {
		super.context=ctx;
	}
	...
	public int execute(AgencyVo agencyVo, Agency agencyEntity,DialogueVo dialogueVo) throws Exception {
		...
		try{
			...
			for(ReferenceDataSaveAgencyCodeRuleFactory.RuleEnum ruleEnum : ReferenceDataSaveAgencyCodeRuleFactory.RuleEnum.values()){
				IRule rule = ReferenceDataSaveAgencyCodeRuleFactory.getInstance(
