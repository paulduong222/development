...
public class CheckPermissionsRules extends AbstractAdminOfficeDeleteRule implements IRule{
	public static final String _RULE_NAME=AdminOfficeDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
