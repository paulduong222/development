...
//		if(!super.allIncidents){
//			error = Validator.validateVoIdField("Incident", super.priorityProgramVo.getIncidentId(), true);
//			if(null != error)errorObjects.add(error);
//		}
		
		error = Validator.validateStringField2("Priority Program", super.priorityProgramVo.getCode(), 50, true);
		if(null != error)errorObjects.add(error);
