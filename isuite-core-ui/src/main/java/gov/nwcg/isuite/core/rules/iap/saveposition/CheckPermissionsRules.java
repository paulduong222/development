...
public class CheckPermissionsRules extends AbstractPositionSaveRule implements IRule {
	public static final String _RULE_NAME=PositionSaveRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
