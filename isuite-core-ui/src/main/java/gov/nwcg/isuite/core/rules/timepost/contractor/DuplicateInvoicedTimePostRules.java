...
public class DuplicateInvoicedTimePostRules extends AbstractContractorRule implements IRule {
		...
		if(null != vo){
			...
			if(DateUtil.hasValue(lastInvoiceDate)){
				...
				if(super.postType.equals("SPECIAL")){
					postDate=DateUtil.addMilitaryTimeToDate(super.specialVo.getPostStartDate(),"2359");
				}else{
					postDate=DateUtil.addMilitaryTimeToDate(vo.getPostStartDate(),"2359");
				}
