...
public class CheckPermissionsRules extends AbstractCostGroupsDeleteRule implements IRule {
	public static final String _RULE_NAME=CostGroupsDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
