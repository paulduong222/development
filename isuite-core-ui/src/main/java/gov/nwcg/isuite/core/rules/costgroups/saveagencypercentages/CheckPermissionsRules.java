...
public class CheckPermissionsRules extends AbstractCostGroupsSaveAgencyPercentagesRule implements IRule {
public static final String _RULE_NAME=CostGroupsSaveAgencyPercentagesRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
