...
public class IapForm204Report2Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_2Comm";
	...
	public IapForm204Report2Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report2Comm.REPORT_NAME;
	}
