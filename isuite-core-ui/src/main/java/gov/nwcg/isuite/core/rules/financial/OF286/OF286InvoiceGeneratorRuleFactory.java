...
public class OF286InvoiceGeneratorRuleFactory {
	...
	public enum RuleEnum {
		...
		,INVC_HAS_COOP_NAME_AND_AGRMNT_NUBMER(15)
		,INVC_HAS_OUTSTANDING_SUPPLIES(20)
		,INVC_HAS_EMPLOYEE_TYPE(25)
		;
	...
	public static IRule getInstance(RuleEnum rule, 
		...
		switch(rule.getRuleIdx())
		{
			...
			case 10:
				...
				break;
			case 15:
				ruleInstance=new HasContractorNameAndAgreementRule(ctx, rule.name());
				break;
			case 20:
