...
public class CheckRunCostAutoRules extends AbstractContractorRule implements IRule{
	public static final String _RULE_NAME=TimePostContractorRuleFactory.RuleEnum.CHECK_RUN_COST_AUTO.name();
