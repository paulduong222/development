...
public class CheckPostEndIncidentDateRules extends AbstractPersonnelRule implements IRule{
	public static final String _RULE_NAME=TimePostPersonnelRuleFactory.RuleEnum.CHECK_POST_END_INCIDENT_DATE.name();
