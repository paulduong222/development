...
public class CheckPermissionsRules extends AbstractAdminOfficeSaveRule implements IRule{
	public static final String _RULE_NAME=AdminOfficeSaveRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
