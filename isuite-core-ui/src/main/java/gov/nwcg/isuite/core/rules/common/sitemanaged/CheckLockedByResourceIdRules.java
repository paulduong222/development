...
public class CheckLockedByResourceIdRules extends AbstractSiteManagedRule implements IRule{
	public static final String _RULE_NAME=SiteManagedRuleFactory.RuleEnum.IS_INCIDENT_LOCKED_BY_RESOURCE_ID.name();
	
	public CheckLockedByResourceIdRules(ApplicationContext ctx)
	{
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		if(LongUtility.hasValue(super.id) 
			...
			incidentResourceId=irDao.getIdByResourceId(super.id);
