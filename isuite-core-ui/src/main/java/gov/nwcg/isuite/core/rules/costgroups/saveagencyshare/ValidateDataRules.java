...
public class ValidateDataRules extends AbstractSaveAgencyShareRule implements IRule {
	public static final String _RULE_NAME=SaveAgencyShareRuleFactory.RuleEnum.VALIDATE_DATA.name();
	...
	private int runRuleCheck(DialogueVo dialogueVo) {
		...
		// check for date
		error=Validator.validateDateField2("Date", super.vo.getAgencyShareDate(), true);
