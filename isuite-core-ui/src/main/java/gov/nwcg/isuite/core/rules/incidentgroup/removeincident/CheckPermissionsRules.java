...
public class CheckPermissionsRules extends AbstractIncidentGroupRemoveIncidentRule implements IRule{
	public static final String _RULE_NAME=IncidentGroupRemoveIncidentRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
