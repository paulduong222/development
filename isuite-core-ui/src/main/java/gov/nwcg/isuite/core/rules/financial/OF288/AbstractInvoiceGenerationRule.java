...
public class AbstractInvoiceGenerationRule extends AbstractRule {
	...
	public void setObject(Object object, String objectName) {
		if(objectName.equals(OF288InvoiceGeneratorRuleFactory.ObjectTypeEnum.NEW_INCIDENT_RESOURCE_VO.name()))
			irs = (Collection<IncidentResourceVo>)object;
		if(objectName.equals(OF288InvoiceGeneratorRuleFactory.ObjectTypeEnum.DATES.name()))
			dates = (Collection<Date>)object;
		if(objectName.equals(OF288InvoiceGeneratorRuleFactory.ObjectTypeEnum.TIME_REPORT_FILTER.name()))
