...
public class FirstWorkDayFieldRule extends AbstractPropagateRule {
	public static final String FIELD_NAME="First Work Day";
	...
	private PropagateFieldPromptVo checkNonStrikeTeamRules(){
		...
		if(!DateUtil.hasValue(super.origParentResourceData.firstWorkDate) && DateUtil.hasValue(super.newParentResourceData.firstWorkDate)){
			for(ResourceData childData : super.childrenResourceData){
				if(!DateUtil.hasValue(childData.firstWorkDate)){
					// do auto propagate
		...
		if(DateUtil.hasValue(super.origParentResourceData.firstWorkDate) && DateUtil.hasValue(super.newParentResourceData.firstWorkDate)){
			if(!DateUtil.isSameDate(origParentResourceData.firstWorkDate,newParentResourceData.firstWorkDate)){
				...
				if(BooleanUtility.isFalse(PropagateFieldPromptVo.hasFieldVo(FIELD_NAME, super.propagateFieldPromptVos))){
					...
					propagateFieldPromptVo.setPromptUserMessage("First Work Day" );
