...
public class CheckResourceEmploymentTypeRules extends AbstractTimeAssignAdjustSaveRule implements IRule{
	public static final String _RULE_NAME=TimeAssignAdjustSaveRuleFactory.RuleEnum.CHECK_RESOURCE_EMP_TYPE.name();
