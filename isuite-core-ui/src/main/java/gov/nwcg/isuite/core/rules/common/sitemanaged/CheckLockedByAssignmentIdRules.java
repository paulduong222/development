...
public class CheckLockedByAssignmentIdRules extends AbstractSiteManagedRule implements IRule{
	public static final String _RULE_NAME=SiteManagedRuleFactory.RuleEnum.IS_INCIDENT_LOCKED_BY_ASSIGNMENT_ID.name();
	
	public CheckLockedByAssignmentIdRules(ApplicationContext ctx)
	{
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		if(LongUtility.hasValue(super.id) 
				&& super.idType.equals("ASSIGNMENT")
			...
			incidentResourceId=assignmentDao.getIncidentResourceId(super.id);
