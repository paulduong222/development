...
public class PromptRemoveParentAssocRules extends AbstractIncidentResourceDeleteRule implements IRule{
	public static final String _RULE_NAME=IncidentResourceDeleteRuleFactory.RuleEnum.PROMPT_REMOVE_PARENT_ASSOC.name();

	public PromptRemoveParentAssocRules(ApplicationContext ctx)
	{
