...
public class CheckPermissionsRules extends AbstractOperationalPeriodDeleteRule implements IRule {
	public static final String _RULE_NAME=OperationalPeriodDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
