...
public class PreventStandardUnitIdDeletionRules extends AbstractDeleteUnitIdRule implements IRule {

	public static final String _RULE_NAME=
		ReferenceDataDeleteUnitIdRuleFactory.RuleEnum.PREVENT_STANDARD_UNIT_ID_DELETION.name();

	public PreventStandardUnitIdDeletionRules(ApplicationContext ctx) {
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		...
		3.	The system must prevent a user from 
			deleting Standard Agency Unit IDs.*/

		if(null != organizationEntity){
			if(BooleanUtility.isTrue(organizationEntity.isStandard())) {
