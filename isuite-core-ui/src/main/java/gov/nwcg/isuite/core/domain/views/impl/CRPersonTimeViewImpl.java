...
import gov.nwcg.isuite.core.domain.views.CRPersonTimeView;
...
@Entity
@Table(name = "iswv_cr_person_time")
public class CRPersonTimeViewImpl implements CRPersonTimeView {
