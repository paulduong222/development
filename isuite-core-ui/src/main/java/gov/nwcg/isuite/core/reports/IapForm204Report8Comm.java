...
public class IapForm204Report8Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_8Comm";
	...
	public IapForm204Report8Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report8Comm.REPORT_NAME;
	}
