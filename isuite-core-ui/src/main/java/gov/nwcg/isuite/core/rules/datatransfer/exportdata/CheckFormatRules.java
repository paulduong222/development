...
public class CheckFormatRules extends AbstractExportDataRule implements IRule {
	public static final String _RULE_NAME=SaveUserRuleFactory.RuleEnum.CHECK_PASSWORD_FORMAT.name();
	...
	private int runRuleCheck(DialogueVo dialogueVo) {
		...
		String newPassword = vo.getFilePassword();
