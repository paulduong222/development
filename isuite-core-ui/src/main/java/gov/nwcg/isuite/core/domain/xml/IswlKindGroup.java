...
@XmlTransferTable(name = "IswlKindGroup", table = "iswl_kind_group")
public class IswlKindGroup {

	@XmlTransferField(name = "Id", sqlname="ID", primarykey=true, sequence="SEQ_KIND_GROUP", type="LONG")
	private Long id = 0L;
