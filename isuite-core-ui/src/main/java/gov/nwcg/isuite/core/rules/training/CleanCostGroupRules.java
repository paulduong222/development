...
public class CleanCostGroupRules extends AbstractTrainingDateSaveRule implements IRule {
	public static final String _RULE_NAME = TrainingDateSaveRuleFactory.RuleEnum.CLEAN_COST_GROUP.name();

	public CleanCostGroupRules(ApplicationContext ctx) {
	...
	public void executePostProcessActions(DialogueVo dialogueVo) throws Exception {
		...
		if(null != super.trainingDate){
			...
			cgAgDsDao.deleteAllAfterDate(newDate);
		}
	}
