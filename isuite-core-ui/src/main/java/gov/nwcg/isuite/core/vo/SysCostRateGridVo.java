...
public class SysCostRateGridVo extends AbstractVo{
	private Long itemId;
	 ...
	 * @return
	 */
	public static Collection<SysCostRateGridVo> applyStateFilters(Collection<SysCostRateGridVo> vos,CostRateGridFilter filter) {
		Collection<SysCostRateGridVo> vos2 = new ArrayList<SysCostRateGridVo>();
		
		Collection<String> stateFilters = CostRateGridFilterImpl.getStateFilters(filter);
		
		if(stateFilters.size()>0){
			
			for(SysCostRateGridVo vo : vos){
				boolean bMatch=true;
	 ...
	 * @return
	 */
	public static Collection<SysCostRateGridVo> applyAdvancedSearch(Collection<SysCostRateGridVo> vos , String advancedSearch) {
		Collection<SysCostRateGridVo> vos2 = new ArrayList<SysCostRateGridVo>();
