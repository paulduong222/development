...
public class CheckPermissionsRules extends AbstractCostGroupsSaveRule implements IRule {
	public static final String _RULE_NAME=CostGroupsSaveRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
