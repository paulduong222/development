...
public class IapForm204Report3Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_3Comm";
	...
	public IapForm204Report3Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report3Comm.REPORT_NAME;
	}
