...
public class CheckResourceStatusRules extends AbstractPersonnelRule implements IRule{
	public static final String _RULE_NAME=TimePostPersonnelRuleFactory.RuleEnum.CHECK_RESOURCE_STATUS.name();
