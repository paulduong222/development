...
public class IapForm204Report5Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_5Comm";
	...
	public IapForm204Report5Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report5Comm.REPORT_NAME;
	}
