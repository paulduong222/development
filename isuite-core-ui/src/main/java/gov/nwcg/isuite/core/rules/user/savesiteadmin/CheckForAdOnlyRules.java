...
public class CheckForAdOnlyRules extends AbstractSaveSiteAdminRule implements IRule {
	public static final String _RULE_NAME=SaveSiteAdminRuleFactory.RuleEnum.CHECK_FOR_AD_ONLY_RULE.name();
