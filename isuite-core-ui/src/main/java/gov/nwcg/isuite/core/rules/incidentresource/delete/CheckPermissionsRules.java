...
public class CheckPermissionsRules extends AbstractIncidentResourceDeleteRule implements IRule{
	public static final String _RULE_NAME=IncidentResourceDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
