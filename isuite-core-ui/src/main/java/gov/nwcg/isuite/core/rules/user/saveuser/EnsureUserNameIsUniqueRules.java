...
public class EnsureUserNameIsUniqueRules extends AbstractSaveUserRule implements IRule {

	public static final String _RULE_NAME=SaveUserRuleFactory.RuleEnum.ENSURE_USER_NAME_IS_UNIQUE_RULE.name();
