...
public class CheckPermissionsRules extends AbstractRestrIncAddUserRule implements IRule{
	public static final String _RULE_NAME=RestrictIncidentAddUserRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
