...
public class CheckAgencyPercentageDateRules extends AbstractCostGroupsSaveAgencyPercentageRule implements IRule {
	public static final String _RULE_NAME=CostGroupsSaveAgencyPercentageRuleFactory.RuleEnum.CHECK_AGENCY_PERCENTAGE_DATE.name();
	
	public CheckAgencyPercentageDateRules(ApplicationContext ctx)
	{
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		 ...
		 */
		//Date systemDate=EISuiteCalendar.getInstance().getTime();	
		...
		Date agencyPctDate=super.dayShareEntity.getAgencyShareDate();
		...
		CostGroup cg =  cgDao.getById(super.dayShareEntity.getCostGroup().getId(), CostGroupImpl.class);
