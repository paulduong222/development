...
public class CheckPermissionsRules extends AbstractPositionDeleteRule implements IRule {
	public static final String _RULE_NAME=PositionDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
