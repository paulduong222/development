...
public class CheckPermissionsRules extends AbstractSaveWorkAreaRule implements IRule{
	public static final String _RULE_NAME=WorkAreaSaveRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
