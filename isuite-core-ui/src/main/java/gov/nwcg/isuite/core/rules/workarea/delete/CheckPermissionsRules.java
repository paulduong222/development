...
public class CheckPermissionsRules extends AbstractDeleteWorkAreaRule implements IRule{
	public static final String _RULE_NAME=WorkAreaDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
