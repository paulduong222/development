...
public class CheckPermissionsRules extends AbstractIncidentSaveCostDefaultsRule implements IRule{
	public static final String _RULE_NAME=IncidentSaveCostDefaultsRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
