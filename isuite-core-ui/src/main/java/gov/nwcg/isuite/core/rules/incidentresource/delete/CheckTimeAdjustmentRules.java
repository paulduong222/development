...
public class CheckTimeAdjustmentRules extends AbstractIncidentResourceDeleteRule implements IRule {
	public static final String _RULE_NAME="CHECK_TIME_ADJUSTMENTS";

	public CheckTimeAdjustmentRules(ApplicationContext ctx){
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		...
		int cnt = taaDao.getResourcesTimeAdjustmentCount(incidentResourceIds);
