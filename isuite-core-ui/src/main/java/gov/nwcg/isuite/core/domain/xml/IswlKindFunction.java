...
@XmlTransferTable(name = "IswlKindFunction", table = "iswl_kind_function")
public class IswlKindFunction {

	@XmlTransferField(name = "Id", sqlname="ID", primarykey=true, sequence="SEQ_KIND_FUNCTION", type="LONG")
	private Long id = 0L;
