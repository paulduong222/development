...
public class ValidationOtherRules extends AbstractCrewRule implements IRule {
	public static final String _RULE_NAME="VALIDATE_OTHER_RULES";
	
	public ValidationOtherRules(ApplicationContext ctx){
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception{
		...
		if(super.employmentType=="OTHER"){
			...
			// check rate  (defect 3398 - not required anymore)
			//error=Validator.validateDecimalField2("Rate", vo.getOtherRate(),  true);
			//if(error!=null)errorObjects.add(error);
