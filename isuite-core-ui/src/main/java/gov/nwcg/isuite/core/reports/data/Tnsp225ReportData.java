...
public class Tnsp225ReportData {
	...
	public Tnsp225ReportData() {
	}

	public static Tnsp225ReportData getInstanceBlankForm() throws Exception {
		Tnsp225ReportData reportData = new Tnsp225ReportData();
		return reportData;
	}

	public static Tnsp225ReportData getInstance() throws Exception {
		Tnsp225ReportData reportData = new Tnsp225ReportData();
