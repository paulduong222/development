...
public class CheckPermissionsRules extends AbstractMasterFrequencySaveRule implements IRule {
	public static final String _RULE_NAME=MasterFrequencySaveRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
