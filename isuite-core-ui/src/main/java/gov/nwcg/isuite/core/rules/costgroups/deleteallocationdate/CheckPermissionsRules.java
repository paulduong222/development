...
public class CheckPermissionsRules extends AbstractCostGroupsDeleteAllocationDateRule implements IRule {
public static final String _RULE_NAME=CostGroupsDeleteAllocationDateRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
