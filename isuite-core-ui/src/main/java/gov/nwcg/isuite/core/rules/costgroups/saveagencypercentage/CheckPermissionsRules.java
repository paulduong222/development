...
public class CheckPermissionsRules extends AbstractCostGroupsSaveAgencyPercentageRule implements IRule {
public static final String _RULE_NAME=CostGroupsSaveAgencyPercentageRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
