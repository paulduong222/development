...
public class CheckPermissionsRules extends AbstractIncidentGroupDeleteQuestionRule implements IRule{
	public static final String _RULE_NAME=IncidentGroupDeleteQuestionRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
