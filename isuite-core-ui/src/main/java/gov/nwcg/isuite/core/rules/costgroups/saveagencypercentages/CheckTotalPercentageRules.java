...
public class CheckTotalPercentageRules extends AbstractCostGroupsSaveAgencyPercentagesRule implements IRule {
	public static final String _RULE_NAME=CostGroupsSaveAgencyPercentagesRuleFactory.RuleEnum.CHECK_TOTAL_PERCENTAGE.name();
