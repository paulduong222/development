...
import gov.nwcg.isuite.core.rules.user.pwd.PasswordValidationRuleFactory;
...
public class ChangePasswordRulesHandler extends AbstractRuleHandler {

	public ChangePasswordRulesHandler(ApplicationContext ctx) {
		super.context = ctx;
	}
