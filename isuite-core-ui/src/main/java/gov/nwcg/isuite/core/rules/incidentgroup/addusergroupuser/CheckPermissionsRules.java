...
public class CheckPermissionsRules extends AbstractAddUserGroupUserIGRule implements IRule{
	public static final String _RULE_NAME=IncidentGroupAddUserGroupUserRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
