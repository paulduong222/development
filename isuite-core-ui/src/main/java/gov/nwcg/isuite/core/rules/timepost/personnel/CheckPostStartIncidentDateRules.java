...
public class CheckPostStartIncidentDateRules extends AbstractPersonnelRule implements IRule{
	public static final String _RULE_NAME=TimePostPersonnelRuleFactory.RuleEnum.CHECK_POST_START_INCIDENT_DATE.name();
			...
			try{
				...
				dialogueVo.setCourseOfActionVo(
						super.buildErrorCoaVo("text.time"
											  ,"validationerror"
											  ,"error.800000"
											  , new String[]{"Error validating earliest incident start date. CheckPostStartIncidentDateRules.java"}));	
				return _FAIL;
			}
		}
