...
import gov.nwcg.isuite.core.rules.datatransfer.importdata.ImportDataRuleFactory;
...
public class DataTransferImportDataRulesHandler extends AbstractRuleHandler {
	
	public DataTransferImportDataRulesHandler(ApplicationContext ctx) {
		super.context=ctx;
	}
