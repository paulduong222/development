...
public class AdminOfficeDeleteRulesHandler extends AbstractRuleHandler {
	
	public AdminOfficeDeleteRulesHandler(ApplicationContext ctx) {
		super.context=ctx;
	}
	...
	public int execute(AdminOfficeVo vo, DialogueVo dialogueVo) throws Exception {
		...
		try{
			...
			for(AdminOfficeDeleteRuleFactory.RuleEnum ruleEnum : AdminOfficeDeleteRuleFactory.RuleEnum.values()){
				IRule rule = AdminOfficeDeleteRuleFactory.getInstance(ruleEnum, context, vo, dao);
