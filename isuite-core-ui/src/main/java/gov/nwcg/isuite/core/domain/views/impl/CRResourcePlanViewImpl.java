...
import gov.nwcg.isuite.core.domain.views.CRResourcePlanView;
...
@Entity
@Table(name = "iswv_cr_resource_plan")
public class CRResourcePlanViewImpl implements CRResourcePlanView {
