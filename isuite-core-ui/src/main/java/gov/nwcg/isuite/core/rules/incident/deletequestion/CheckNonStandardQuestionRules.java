...
public class CheckNonStandardQuestionRules extends AbstractIncidentDeleteQuestionRule implements IRule{
	public static final String _RULE_NAME=IncidentDeleteQuestionRuleFactory.RuleEnum.CHECK_NON_STANDARD_QUESTION.name();
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		...
		if(entity.getQuestion().isStandard()){
			...
			coaVo.setMessageVo(new MessageVo("text.incidentSettings"
												, errorMsg
												, null
