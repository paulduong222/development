...
public class CheckMaxDBCountRules extends AbstractDbMgmtSaveRule implements IRule {
	public static final String _RULE_NAME = DbMgmtSaveRuleFactory.RuleEnum.CHECK_MAX_DB_COUNT.name();
