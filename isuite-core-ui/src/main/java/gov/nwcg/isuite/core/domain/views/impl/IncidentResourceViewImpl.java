...
import gov.nwcg.isuite.core.domain.views.IncidentResourceView;
 ...
 */
@Entity
@Table(name = "iswv_resource_incident")
public class IncidentResourceViewImpl implements IncidentResourceView {
    ...
    public IncidentResourceViewImpl() {
