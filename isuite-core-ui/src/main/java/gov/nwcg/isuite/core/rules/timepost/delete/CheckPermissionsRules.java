...
public class CheckPermissionsRules extends AbstractTimePostDeleteRule implements IRule{
	public static final String _RULE_NAME = TimePostDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
