...
public class IapForm204Report0Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_0Comm";
	...
	public IapForm204Report0Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report0Comm.REPORT_NAME;
	}
