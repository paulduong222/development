...
public class CheckTimePostingRules extends AbstractIncidentResourceDeleteRule implements IRule {
	public static final String _RULE_NAME="CHECK_TIME_POSTINGS";
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		...
		int cnt = timePostDao.getResourcesTimePostCount(incidentResourceIds);
