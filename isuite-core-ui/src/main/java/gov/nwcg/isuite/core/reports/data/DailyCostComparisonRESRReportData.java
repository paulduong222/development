...
/**
 * Report data object for DailyCostComparisonRESRReport.jrxml.
 */
public class DailyCostComparisonRESRReportData {
	
	private Long incidentId;
	private String incidentName;
	private String incidentNumber;
	private List<DailyCostComparisonRESRSubReportData> subReportData = new ArrayList<DailyCostComparisonRESRSubReportData>();
	 ...
	 */
	public Collection<DailyCostComparisonRESRSubReportData> getSubReportData() {
	 ...
	 */
	public void setSubReportData(Collection<DailyCostComparisonRESRSubReportData> subReportData) {
		this.subReportData = (List<DailyCostComparisonRESRSubReportData>)subReportData;
	}
