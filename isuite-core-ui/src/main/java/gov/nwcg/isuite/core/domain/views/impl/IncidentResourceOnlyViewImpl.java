...
import gov.nwcg.isuite.core.domain.views.IncidentResourceOnlyView;
 ...
 */
@Entity
@Table(name = "iswv_resource_incident_only")
public class IncidentResourceOnlyViewImpl implements IncidentResourceOnlyView {
    ...
    public IncidentResourceOnlyViewImpl() {
