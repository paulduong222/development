...
public class CheckPermissionsRules extends AbstractRestrIncAddUserGroupUserRule implements IRule{
	public static final String _RULE_NAME=RestrictIncidentAddUserFromUserGroupRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
