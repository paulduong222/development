...
import gov.nwcg.isuite.core.rules.timeassignadjust.save.TimeAssignAdjustSaveRuleFactory;
...
public class TimeAssignAdjustSaveRulesHandler extends AbstractRuleHandler {

	public TimeAssignAdjustSaveRulesHandler(ApplicationContext ctx) {
		super.context=ctx;
	}
	 ...
	 * @throws Exception
	 */
	public int execute(TimeAssignAdjust entity,IncidentResourceVo irvo, Assignment assignmentEntity,TimeAssignAdjustVo vo, DialogueVo dialogueVo) throws Exception {
		...
		try{
			...
			for(TimeAssignAdjustSaveRuleFactory.RuleEnum ruleEnum : TimeAssignAdjustSaveRuleFactory.RuleEnum.values()){
				IRule rule = TimeAssignAdjustSaveRuleFactory.getInstance(ruleEnum
																		, context
																		,irvo
																		, vo
																		, entity
	 ...
	 * @throws Exception
	 */
	public int executeProcessedActions(TimeAssignAdjust entity, IncidentResourceVo irvo, Assignment assignmentEntity,TimeAssignAdjustVo vo, DialogueVo dialogueVo) throws Exception {
