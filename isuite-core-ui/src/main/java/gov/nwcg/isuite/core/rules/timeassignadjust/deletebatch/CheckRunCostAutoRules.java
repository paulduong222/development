...
public class CheckRunCostAutoRules extends AbstractTimeAssignAdjustDeleteBatchRule implements IRule{
	public static final String _RULE_NAME=TimeAssignAdjustDeleteBatchRuleFactory.RuleEnum.CHECK_COST_AUTORUN.name();
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		...
		Long incId = super.taaDao.getIncidentId(super.timeAssignAdjustEntity.getAssignmentId());
		...
		if(BooleanUtility.isTrue(val)){
			...
			Long irId = super.taaDao.getIncidentResourceId(super.timeAssignAdjustEntity.getAssignmentId());
