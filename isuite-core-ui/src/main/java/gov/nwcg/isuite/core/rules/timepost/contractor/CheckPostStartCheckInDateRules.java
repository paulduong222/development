...
public class CheckPostStartCheckInDateRules extends AbstractContractorRule implements IRule{
	public static final String _RULE_NAME=TimePostContractorRuleFactory.RuleEnum.CHECK_POST_START_CHECKIN_DATE.name();
