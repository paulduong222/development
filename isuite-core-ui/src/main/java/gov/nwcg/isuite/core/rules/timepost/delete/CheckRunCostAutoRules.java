...
public class CheckRunCostAutoRules extends AbstractTimePostDeleteRule implements IRule{
	public static final String _RULE_NAME=TimePostDeleteRuleFactory.RuleEnum.CHECK_RUN_COST_AUTO.name();
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		...
		if(null == entity.getAssignmentTimeId())
			return _OK;
		
		IncidentResourceDao irDao = (IncidentResourceDao)context.getBean("incidentResourceDao");
		IncidentResource irEntity = irDao.getByAssignmentTimeId(super.entity.getAssignmentTimeId());
		if(null != irEntity){
			...
			if(BooleanUtility.isTrue(incident.getCostAutoRun().getValue())){
				...
				courseOfActionVo.setStoredObject(super.entity.getPostStartDate());
