...
import gov.nwcg.isuite.core.rules.datatransferv2.importdata.ImportDataRuleFactory;
...
public class DataTransferV2ImportDataRulesHandler extends AbstractRuleHandler {
	
	public DataTransferV2ImportDataRulesHandler(ApplicationContext ctx) {
		super.context=ctx;
	}
