...
public class CheckRunCostAutoRules extends AbstractTimeAssignAdjustDeleteRule implements IRule{
	public static final String _RULE_NAME=TimeAssignAdjustDeleteRuleFactory.RuleEnum.CHECK_COST_AUTORUN.name();
