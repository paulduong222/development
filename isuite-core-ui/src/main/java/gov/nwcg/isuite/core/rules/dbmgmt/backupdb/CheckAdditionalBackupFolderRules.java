...
public class CheckAdditionalBackupFolderRules extends AbstractDbMgmtBackupRule implements IRule {
	public static final String _RULE_NAME = DbMgmtBackupRuleFactory.RuleEnum.CHECK_ADDITIONAL_BACKUP_FOLDER.name();
	...
	private int runRuleCheck(DialogueVo dialogueVo) throws Exception {
		 ...
		 */
		try{
			if(StringUtility.hasValue(super.altDestination)){
				Boolean isValidFolder=false;

				try{
					isValidFolder=FileUtil.isFolder(super.altDestination)==true;
				}catch(Exception fe){
