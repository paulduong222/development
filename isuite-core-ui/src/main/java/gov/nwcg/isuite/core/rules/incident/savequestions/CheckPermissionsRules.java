...
public class CheckPermissionsRules extends AbstractIncidentSaveQuestionsRule implements IRule{
	public static final String _RULE_NAME=IncidentSaveQuestionsRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
