...
public class CheckPermissionsRules extends AbstractUnrestrictIncidentRule implements IRule{
	public static final String _RULE_NAME=UnrestrictIncidentRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
