...
public class AbstractRossImportEndRule extends AbstractRule {
	...
	public void setObject(Object object, String objectName) {
		if(objectName.equals(RossImportProcessEndRuleFactory.ObjectTypeEnum.ROSS_XML_FILE_VO.name()))
			rxfVo = (RossXmlFileVo)object;
		if(objectName.equals(RossImportProcessEndRuleFactory.ObjectTypeEnum.ROSS_IMPORT_VO.name()))
			rossImportVo = (RossImportVo)object;
		if(objectName.equals(RossImportProcessEndRuleFactory.ObjectTypeEnum.USER_VO.name()))
