...
/**
 * Report data object for MissingDaysOfPostingsReport.jrxml.
 */
public class MissingDaysOfPostingsReportData {
	
	private Long incidentId;
	private String incidentName;
	private String incidentNumber;
	private List<MissingDaysOfPostingsSubReportData> subReportData = new ArrayList<MissingDaysOfPostingsSubReportData>();
	 ...
	 */
	public Collection<MissingDaysOfPostingsSubReportData> getSubReportData() {
	 ...
	 */
	public void setSubReportData(Collection<MissingDaysOfPostingsSubReportData> subReportData) {
		this.subReportData = (List<MissingDaysOfPostingsSubReportData>)subReportData;
	}
