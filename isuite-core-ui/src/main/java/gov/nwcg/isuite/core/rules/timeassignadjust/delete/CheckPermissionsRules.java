...
public class CheckPermissionsRules extends AbstractTimeAssignAdjustDeleteRule implements IRule{
	public static final String _RULE_NAME=TimeAssignAdjustDeleteRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
