...
public class IapForm204Report6Comm extends BaseReport implements IReport {
	
	private static final String REPORT_NAME="IAP_FORM_204_6Comm";
	...
	public IapForm204Report6Comm(Collection<IapForm204ReportData> data) {
		super();
	...
	public String getReportName() {
		return IapForm204Report6Comm.REPORT_NAME;
	}
