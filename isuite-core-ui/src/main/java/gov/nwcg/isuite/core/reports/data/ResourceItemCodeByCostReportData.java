...
public class ResourceItemCodeByCostReportData {
	
	private Long incidentId;
	private String incidentName;
	private String incidentNumber;
	private List<ResourceItemCodeByCostSubReportData> subReportData = new ArrayList<ResourceItemCodeByCostSubReportData>();
	 ...
	 */
	public Collection<ResourceItemCodeByCostSubReportData> getSubReportData() {
	 ...
	 */
	public void setSubReportData(Collection<ResourceItemCodeByCostSubReportData> subReportData) {
		this.subReportData = (List<ResourceItemCodeByCostSubReportData>)subReportData;
	}
