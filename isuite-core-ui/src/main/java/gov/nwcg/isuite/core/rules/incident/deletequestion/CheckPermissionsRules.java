...
public class CheckPermissionsRules extends AbstractIncidentDeleteQuestionRule implements IRule{
	public static final String _RULE_NAME=IncidentDeleteQuestionRuleFactory.RuleEnum.CHECK_PERMISSIONS.name();
